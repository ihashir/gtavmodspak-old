...
if($row['slider'] == 'true'){
    ...
    $value = str_replace('_d.webp', '.jpg', $value);

    echo '<div class="carousel-item '.$active.'">
<img class="d-block" src="'.$value.'" alt="slide">
</div>';
$active = "";
}
...
<div class="dnBtndiv"><a target="_blank" href="'.$dnlink.'"><button type="button" class="mt-3 btn btn-success p-2 pr-4 pl-4 dnBtn">DOWNLOAD</button></a>';
